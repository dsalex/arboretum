export CXX  = nvcc
export LDFLAGS= -lm -gencode arch=compute_60,code=compute_60
export CFLAGS = -O3 -gencode arch=compute_60,code=compute_60 -std=c++11 -ccbin=g++ -Xcompiler -fPIC -Xcompiler -O3

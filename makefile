export CXX  = nvcc
export LDFLAGS= -lm -gencode arch=compute_61,code=compute_61
export CFLAGS = -O3 -gencode arch=compute_61,code=compute_61 -std=c++11 -ccbin=g++ -Xcompiler -fPIC -Xcompiler -O3
